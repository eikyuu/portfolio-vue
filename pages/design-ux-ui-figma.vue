  ...
  <section>
    <div class="block flex justify-center">
      <h1
        ...
        <span class="relative text-[#5A3B5D] font-bold text-2xl md:text-3xl xl:text-4xl">Design UX/UI : Création
          d'Expériences Utilisateurs Exceptionnelles</span>
      </h1>
...
</article>" img="book.jpg" width="600" height="600" />
    <Contact />
  </section>
</template>
