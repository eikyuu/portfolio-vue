<template>
  <section>
    ...
    <div class="block flex justify-center">
        <h1
            ...
            <span class="relative text-[#5A3B5D] font-bold text-2xl md:text-3xl xl:text-4xl">Design UX/UI : Création d'Expériences Utilisateurs Exceptionnelles</span>
        </h1>

    </div>


    <ExpertiseCard link="/contact" textBtn="Je veux un design qui me ressemble →" text="<article>
  <!-- Introduction -->
  <p>
    Vous souhaitez offrir une expérience utilisateur fluide, engageante et mémorable ? En tant que designer UX/UI expérimenté, je vous accompagne dans la conception d'interfaces intuitives et fonctionnelles qui répondent aux besoins de vos utilisateurs et atteignent vos objectifs commerciaux.
  </p>

  <!-- Sous-titre : Compétences en Design UX -->
  <h2 class='text-2xl font-semibold mt-5 mb-3'>Design UX : Comprendre et Satisfaire les Utilisateurs</h2>

  <p>
    Le design UX se concentre sur l'expérience globale de l'utilisateur. Voici comment je travaille pour créer des solutions centrées sur vos utilisateurs :
  </p>
  ...
  <!-- Sous-titre : Compétences en Design UI -->
  <h2 class='text-2xl font-semibold mt-5 mb-3'>Design UI : Interfaces Visuelles Modernes et Attractives</h2>

  <p>
    Le design UI donne vie à votre produit grâce à des interfaces visuellement attrayantes et cohérentes. Je travaille avec les outils suivants :
  </p>
  ...
  <!-- Sous-titre : Processus de Design -->
...
img="design.svg" class="mt-20 md:mt-20" />
    <Contact />
  </section>
</template>
