<template>
    <section class="mt-20 md:mt-32">
      ...
      <!-- Carte d'expertise -->
      <ExpertiseCard text-btn="Je veux un site WordPress performant →" img="svg/web.svg" alt="Développement WordPress sur mesure">
        <article>
          <!-- Introduction -->
          <p>
  ...
  useSeoMeta({
    title: 'Développement WordPress : Sites Web Performants et Sur Mesure',
